...
namespace HeathenEngineering.SteamAPI
{
    ...
    /// <para>The <see cref="UserData"/> object provides access and real time update of a given user's display name, avatar, game state informaiton and persona state information.</para>
    /// <para>This object should not be created manually but rather looked up or generated by calling <see cref="SteamSettings.Client"/>.<see cref="SteamSettings.GameClient.GetUserData(CSteamID)">GetUserData</see></para>
    /// </summary>
    /// <remarks>
    /// <para>
    ...
    /// <list type="bullet">
    /// <item>
    /// <description>To fetch the local user's <see cref="UserData"/> object you can the userData member of <see cref="SteamSettings.Client"/>, however for demonstration purposes this is how you would look it up by CSteamID</description>
    /// <code>
    ...
    /// </example>
    [Serializable]
    [CreateAssetMenu(menuName = "Steamworks/User Data")]
