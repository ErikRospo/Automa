...
namespace HeathenEngineering.SteamAPI.Editors
{
    ...
    public class SteamSettingsEditor : Editor
    {
        ...
        private void RemoteStorageHeader()
        {
            ...
            settings.client.remoteStorage.DataModels.RemoveAll(p => p == null);
        ...
        private void DrawInventoryArea()
        {
            ...
            settings.client.inventory.itemDefinitions.RemoveAll(p => p == null);
            settings.client.inventory.itemBundles.RemoveAll(p => p == null);
            settings.client.inventory.itemGenerators.RemoveAll(p => p == null);
            settings.client.inventory.tagGenerators.RemoveAll(p => p == null);
