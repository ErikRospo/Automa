...
namespace HeathenEngineering.SteamAPI
{
    ...
    public class SteamworksBehaviour : MonoBehaviour
    {
        ...
        public UnityLeaderboardRankChangeEvent evtLeaderboardRankChanged = new UnityLeaderboardRankChangeEvent();
        public UnityLeaderboardRankUpdateEvent evtLeaderboardRankLoaded = new UnityLeaderboardRankUpdateEvent();
        public UnityLeaderboardRankChangeEvent evtLeaderboardNewHighRank = new UnityLeaderboardRankChangeEvent();
        /// <summary>
        /// Occures when a file read async operation is completed.
        /// </summary>
        public UnityEvent evtFileReadAsyncComplete = new UnityEvent();
        /// <summary>
        /// Occures when a file write operation is completed.
        /// </summary>
        public UnityEvent evtFileWriteAsyncComplete = new UnityEvent();
        /// <summary>
        ...
        /// </summary>
        public UnityFileShareResultEvent evtFileShareResult = new UnityFileShareResultEvent();
#endif
#if HE_STEAMCOMPLETE
        ...
        /// </summary>
        public UnityBoolEvent evtOverlayActivated = new UnityBoolEvent();
        /// <summary>
        /// An event raised when user stats are updated.
        /// This is only avilable in client builds.
        /// </summary>
        public UnityUserStatsReceivedEvent evtUserStatsRecieved = new UnityUserStatsReceivedEvent();
        /// <summary>
        /// An event raised when user stats are stored to the server.
        /// This is only avilable in client builds.
        /// </summary>
        public UnityUserStatsStoredEvent evtUserStatsStored = new UnityUserStatsStoredEvent();
        /// <summary>
        /// An event raised when number of current players of this game has been updated in the local cashe.
        /// This is only avilable in client builds.
        /// </summary>
        public UnityNumberOfCurrentPlayersResultEvent evtNumberOfCurrentPlayersResult = new UnityNumberOfCurrentPlayersResultEvent();
        /// <summary>
        /// An event raised when achievements have been stored to the server.
        /// This is only avilable in client builds.
        /// </summary>
        public UnityUserAchievementStoredEvent evtAchievementStored = new UnityUserAchievementStoredEvent();
        /// <summary>
        /// An event raised when a user avatar has been loaded e.g. the image represening a user.
        /// This is only avilable in client builds.
        /// </summary>
        public UnityAvatarImageLoadedEvent evtAvatarLoaded = new UnityAvatarImageLoadedEvent();
        /// <summary>
        /// An event raised when information about a Steamworks User's persona state has been updated.
        /// This is only avilable in client builds.
        /// </summary>
        public UnityPersonaStateChangeEvent evtPersonaStateChanged = new UnityPersonaStateChangeEvent();
        /// <summary>
        /// An event raised when when a chat message from a friend has been recieved.
        /// This is only avilable in client builds.
        /// </summary>
        public FriendChatMessageEvent evtRecievedFriendChatMessage = new FriendChatMessageEvent();
#endif
        ...
        public UnityEvent evtGameServerShuttingDown = new UnityEvent();
        /// <summary>
        /// An event raised when by Steamworks debugging on disconnected.
        /// This is only avilable in server builds.
        /// </summary>
        [FormerlySerializedAs("Disconnected")]
        public SteamSettings.GameServer.DisconnectedEvent evtDisconnected = new SteamSettings.GameServer.DisconnectedEvent();
        /// <summary>
        /// An event raised by Steamworks debugging on connected.
        /// This is only avilable in server builds.
        /// </summary>
        [FormerlySerializedAs("Connected")]
        public SteamSettings.GameServer.ConnectedEvent evtConnected = new SteamSettings.GameServer.ConnectedEvent();
        /// <summary>
        /// An event raised by Steamworks debugging on failure.
        /// This is only avilable in server builds.
        /// </summary>
        [FormerlySerializedAs("Failure")]
        public SteamSettings.GameServer.FailureEvent evtFailure = new SteamSettings.GameServer.FailureEvent();

        public SteamSettings.GameServer.UnloadedStatsEvent evtStatusUnloaded = new SteamSettings.GameServer.UnloadedStatsEvent();
#endif
        #endregion
            ...
            if(SteamSettings.Initialized)
            {
                if (settings.isDebugging || Application.isEditor)
                    Debug.LogWarning("Detected duplicate initalization!\nInitalization will be aborted, this is most offten caused when you have defined the Steamworks Behaviour object in a scene that is loaded multiple times. " +
                        ...
                        "You can create the Steamworks Behaviour object on demand with a single line call via 'SteamSettings.CreateBehaviour(...)' or by using the 'Steamworks Creator' componenet on a GameObject.");
                abortedInitalization = true;
                enabled = false;
                return;
            }
...
#if HE_STEAMCOMPLETE
            if (settings != null)
                settings.client.clanSystem.clans.Clear();
#endif
