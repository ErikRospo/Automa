...
namespace HeathenEngineering.SteamAPI
{
    ...
    /// </remarks>
    [HelpURL("https://kb.heathenengineering.com/assets/steamworks/steam-settings")]
    ...
    public class SteamSettings : ScriptableObject
    {
        ...
        public class GameClient
        {
            ...
            public class Overlay
            {
                ...
                /// <para>The following examples assume a variable or paramiter of type <see cref="SteamSettings"/> is available and named settings.</para></description>
                /// <code>
                ...
                /// <summary>
                /// <para>A wrap around <see cref="SteamFriends.ActivateGameOverlayInviteDialog(CSteamId lobbyId)"/>.</para>   
                ...
                /// <para>The following examples assume a variable or paramiter of type <see cref="SteamSettings"/> is available and named settings and that myLobby is a valid lobby id.</para></description>
                /// <code>
...
#pragma warning restore IDE0052 // Remove unread private members
            ...
            /// object and the connected <see cref="SteamworksBehaviour"/>
            /// </para>
            ...
            private void HandleUserStatsReceived(UserStatsReceived_t pCallback)
            {
                ...
                if ((ulong)m_GameID == pCallback.m_nGameID)
                {
                    if (EResult.k_EResultOK == pCallback.m_eResult)
                    {
                        ...
                        {
                            if (stat.Type == StatObject.DataType.Float)
                            {
                                float rValue;
            ...
            public void SetStat(int value, uint statIndex)
            {
                var target = Stats[System.Convert.ToInt32(statIndex)];
                if (target != default)
                    target.SetIntStat(value);
            }

            public void SetStat(float value, uint statIndex)
            {
                var target = Stats[System.Convert.ToInt32(statIndex)];
                if (target != default)
                    target.SetFloatStat(value);
            }

            public void SetStat(int value, StatObject stat) => stat.SetIntStat(value);

            public void SetStat(float value, StatObject stat) => stat.SetFloatStat(value);

            public bool ResetAllStats(bool andAchievements) => SteamUserStats.ResetAllStats(andAchievements);
            ...
            /// <a href="https://partner.steamgames.com/doc/api/ISteamUserStats#SetAchievement">https://partner.steamgames.com/doc/api/ISteamUserStats#SetAchievement</a>
            /// </summary>
            public void UnlockAchievementData(AchievementObject data) => data.Unlock();
            ...
            /// <summary>
            /// For internal use, this regisers the Friend system
            /// </summary>
            /// <param name="data"></param>
            ...
            /// <returns>The <see cref="SteamUserData"/> for the indicated user.</returns>
            /// <example>
            /// <list type="bullet">
            /// <item>
            /// <description>Get the <see cref="SteamUserData"/> of a Steamworks user whose ID is stored in myFriendId</description>
            /// <code>
...
#if HE_STEAMCOMPLETE
            MatchmakingTools.Unload();
            RemoteStorageSystem.Unload();
            SteamworksInventoryTools.Unload();
#endif
        }
        ...
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetAppID">https://partner.steamgames.com/doc/api/ISteamUtils#GetAppID</a>
        /// </remarks>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns the Steamworks server time in Unix epoch format. (Number of seconds since Jan 1, 1970 UTC)
        /// </summary>
        /// <remarks>
        /// <para>Returns the Steamworks server time in Unix epoch format. (Number of seconds since Jan 1, 1970 UTC)</para>  
        /// <a href="https://partner.steamgames.com/doc/api/ISteamUtils#GetServerRealTime">https://partner.steamgames.com/doc/api/ISteamUtils#GetServerRealTime</a>
        /// </remarks>
        /// <returns></returns>
        ...
        /// <summary>
        /// Returns the Steamworks server time as a System.DateTime object
        /// </summary>
        /// <remarks>
        /// <para>Returns the Steamworks server time as a System.DateTime object</para>  
