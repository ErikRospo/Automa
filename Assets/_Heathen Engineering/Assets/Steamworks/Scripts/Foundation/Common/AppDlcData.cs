...
namespace HeathenEngineering.SteamAPI
{
    ...
    /// This is returned by <see cref="SteamSettings.GetDLCData"/>
    /// </summary>
    /// <example>
    /// <list type="bullet">
    /// <item>
    ...
    /// <code>
    /// var results = SteamSettings.GetDLCData();
    /// foreach(var result in results)
    /// {
    ///    Debug.Log("Located DLC " + result.name " with an AppId of " + result.appId.ToString() + ", this DLC is " + (result.available ? "available!" : "not available!"));
    /// }
    /// </code>
    /// </item>
    /// </list>
